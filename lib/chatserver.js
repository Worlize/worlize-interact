...
ChatServer.prototype = {
    ...
    markAsHandshaked: function(client) {
        ...
        this.presenceDB.set('interactServerForUser:'+client.session.user.guid, this.serverId, function(err, result) {
          self.presenceDB.expire('interactServerForUser:'+client.session.user.guid, twentyFourHours);
        });
    },
