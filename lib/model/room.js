...
var Room = function(chatserver, guid) {
    ...
    this.presenceDB.zadd('activeRooms', 0, this.guid);
    ...
    this.loadData(function(err, definition) {});
...
Room.prototype.userEnter = function(newUser) {
    ...
    if (!this.usersByUserGuid[newUser.guid]) {
        ...
        this.presenceDB.zadd('activeRooms', this.users.length, this.guid);
...
Room.prototype.destroy = function() {
    ...
    this.presenceDB.del('roomUsers:'+this.guid);
    this.presenceDB.zrem('activeRooms', this.guid);
