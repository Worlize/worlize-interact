...
Room.prototype.initAppData = function() {
    ...
    this.definition.objects.forEach(function(obj) {
        if (obj.kind === 'app') {
            if (!self.appStateHistoryLists[obj.guid]) {
                self.appStateHistoryLists[obj.guid] = new StateHistoryList(obj.guid);
            }
        }
    });
    ...
    this.definition.objects.forEach(function(obj) {
        if (obj.kind === 'app') {
            if (!self.appSyncedDataStores[obj.guid]) {
                self.appSyncedDataStores[obj.guid] = {};
            }
        }
    })
};
...
Room.prototype.addUser = function(user) {
    ...
    var apps = this.definition.objects.filter(function(item) { return item.kind === 'app'; });
